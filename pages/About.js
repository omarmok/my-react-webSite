...
function About() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('https://api.npoint.io/16e3d8319949e6753d67');
      ...
      <div className="container">
        <div className="page__container">
          ...
          Experience
            ...
            <div className="d-flex downloadresume"><a href="https://drive.google.com/file/d/1bDCPs7nSuhpRPNRJAshZelEn_WKj7vkU/view?usp=sharing" className="btn section__title--btn  mt-3  homebtn" target="_blank" rel="noopener noreferrer"> Download Resume </a></div>
          </h1>
